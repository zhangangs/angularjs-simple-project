(function () {
  ...
  Auth.$inject = ['$rootScope', '$state', '$sessionStorage', '$q', '$translate', 'Principal', 'AuthServerProvider', 'Account', 'LoginService', 'Register'];

  function Auth($rootScope, $state, $sessionStorage, $q, $translate, Principal, AuthServerProvider, Account, LoginService, Register) {
    var service = {
    ...
    function checkMobile(mobile) {
      var cb = callback || angular.noop;
      return Register.checkMobile(mobile, function () {
        return cb(mobile);
      },
        function (err) {
          return cb(err);
